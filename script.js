...
// });
        ...
        document.getElementById('searchBar').addEventListener('input', function() {
            ...
            else  if (searchQuery == 'sala 127') fun127();
            else  if (searchQuery == 'sala 121') fun121();
            else  if (searchQuery == 'sala 120') fun120();
            else  if (searchQuery == 'sala 119') fun119();
            else  if (searchQuery == 'sala 118') fun118();
            else  if (searchQuery == 'sala 117') fun117();
            else  if (searchQuery == 'sala 116') fun116();
            else  if (searchQuery == 'sala 233') fun233();
            else  if (searchQuery == 'sala 230') fun230();
            else  if (searchQuery == 'sala 234') fun234();
            else  if (searchQuery == 'sala 204-ET') fun204ET();
            else  if (searchQuery == 'sala 207') fun207();
            else  if (searchQuery == 'sala 220') fun220();
            else  if (searchQuery == 'sala 218') fun218();
            else  if (searchQuery == 'sala 228') fun228();
            else  if (searchQuery == 'sala 128') fun128();
            else  if (searchQuery == 'sala 132') fun132();
            else  if (searchQuery == 'sala 133') fun133();
            else  if (searchQuery == 'sala 135') fun135();
            else  if (searchQuery == 'sala 136') fun136();
            else  if (searchQuery == 'sala 137') fun137();
            else  if (searchQuery == 'sala 227') fun227();
            else  if (searchQuery == 'sala 229') fun229();
            else  if (searchQuery == 'sala 236') fun236();
            else  if (searchQuery == 'sala 14') fun14();
            else  if (searchQuery == 'sala 13') fun13();
            else  if (searchQuery == 'sala 12') fun12();
            else  if (searchQuery == 'sala 113') fun113();
            else  if (searchQuery == 'sala 112') fun112();
            else  if (searchQuery == 'sala 109') fun109();
            else  if (searchQuery == 'sala 107-A') fun107A();
            else  if (searchQuery == 'sala 210') fun210();
            else  if (searchQuery == 'sala 211') fun211();
            else  if (searchQuery == 'sala 212') fun212();
            else  if (searchQuery == 'sala 213') fun213();
            else  if (searchQuery == 'sala 214') fun214();
            else  if (searchQuery == 'sala 215') fun215();
            else  if (searchQuery == 'sala 216') fun216();
